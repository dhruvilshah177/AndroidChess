...
/**
 * Base class for everything in the app
 *
 * @author Dhruvil Shah
...
public class ActivityBase extends AppCompatActivity {
    ...
    public static final String LASTGAME = "LastGame";
    //
    private static final String GAME_FILE = ".cgcs46";
    public static final String TMS_FORMAT = "yyyyMMddHHmmss";

    public static GuiGame guiG;
    ...
    public static List<String> getListFilesName(File parentDir) {
        ...
        while (!files.isEmpty()) {
            ...
            else if (file.getName().endsWith(GAME_FILE)) {
    ...
    public static String makeFileName(File parentDir, String input) {
        ...
        //
        return parentDir.getPath() + File.separator + tms + input + GAME_FILE;
    }


    public static String getTitleFromFileName(String input) {
        String szTemp = input.substring(0, input.length()-GAME_FILE.length());
